      ...
      <div class="layui-tab layui-tab-brief" lay-filter="user">
        ...
        <div class="layui-form layui-tab-content" id="LAY_ucm" style="padding: 20px 0;">
          <div class="layui-tab-item layui-show">
            <validation-observer ref="regForm">
              <div class="layui-form layui-form-pane">
                <form method="post" @submit.prevent="onSubmit">
                  <ValidationProvider rules="required|email" v-slot="{errors}" name="username">
                  ...
                  <ValidationProvider rules="required|length:4" v-slot="{errors}" name="code">
                    <div class="layui-form-item">
    ...
    onSubmit () {
      this.$refs.regForm.validate().then(success => {
        ...
        register({
          ...
          if (res.code === 200) {
            this.username = this.nickname = this.password = this.rePassword = this.code = this.svg = ''
